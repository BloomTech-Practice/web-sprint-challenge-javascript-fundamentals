...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀:
// because of scope, since nestedFunction cannot find the variable "internal" it looks out of its scope and finds it there. This also makes this a closure since the nested function reaches out to is parent scope for a value
...
function summation(num) {
  // return (num * (num + 1)) / 2; <- easy formula
...
console.log(greeting("juan", "Ruiz"));
